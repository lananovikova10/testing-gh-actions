...
<tldr>
    ...
    <p><img src="icon-1-done.svg" width="20" alt="First step"/> <a href="How-to-do-things.md">Create a Spring Boot project with Kotlin</a></p>
</tldr>
...
`Message` class will be used for data transfer: a list of serialized `Message` objects will make up the JSON document that the controller is going to respond to the browser request.
   ...
   <deflist collapsible="true">
       <def title="Data classes – data class Message">
          <p>The main purpose of <a href="How-to-do-things.md">data classes</a> in Kotlin is to hold data. Such classes are marked with the <code>data</code> keyword, and some standard functionality and some utility functions are often mechanically derivable from the class structure.</p>
       ...
       <def title="val and var properties">
          <p><a href="How-to-do-things.md">Properties in Kotlin</a> classes can be declared either as:</p>
          <list>
              <ul>
       ...
       <def title="Nullable types – String?">
          <p>Kotlin provides <a href="How-to-do-things.md">built-in support for nullable types</a>. In Kotlin, the type system distinguishes between references that can hold <code>null</code> (<i>nullable references</i>) and those that cannot (<i>non-nullable references</i>).<br/>
...
<deflist collapsible="true">
       ...
       <def title="Trailing comma">
          <p>A <a href="How-to-do-things.md">trailing comma</a> is a comma symbol after the <strong>last item</strong> of a series of elements:
            <code style="block" lang="kotlin">
            Message("3", "Privet!"),
            </code>
